...
def do_connect(ssid, password):
    ...
    UpdateLabel(True,'Trying to connect to %s...' % ssid)
...
def start(port=80):
    ...
    UpdateLabel(True, 'Please configure my Wi-Fi')
    UpdateLabel(False,'Connect to ' + ap_ssid + '/' + ap_password + '\nand go to 192.168.4.1\n')
